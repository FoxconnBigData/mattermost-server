...
func (a *OpenTracingAppLayer) AuthenticateTokenForLogin(code string, service string) (user *model.User, err *model.AppError) {
	origCtx := a.ctx
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.AuthenticateTokenForLogin(code, service)
